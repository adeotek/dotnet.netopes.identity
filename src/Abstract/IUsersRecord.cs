...
namespace Netopes.Identity.Abstract
{
    /// <summary>
    ...
    public interface IUsersOnlyRecord<TUser, TKey, TUserClaim, TUserLogin, TUserToken>
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        Task<bool> UpdateAsync(TUser user, IList<TUserClaim> claims, IList<TUserLogin> logins,
    ...
    /// <typeparam name="TUserToken">The type representing a user token.</typeparam>
    public interface
        IUsersRecord<TUser, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken> : IUsersOnlyRecord<TUser, TKey,
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        /// <param name="logins">The logins of the user.</param>
        /// <param name="tokens">The tokens of the user.</param>
        Task<bool> UpdateAsync(TUser user, IList<TUserClaim> claims, IList<TUserRole> roles, IList<TUserLogin> logins,
            IList<TUserToken> tokens);
